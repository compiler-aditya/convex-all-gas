          ...
          <div className="landing-hero-copy">
            ...
            <div className="landing-hero-action-wrap">
              <div className="landing-hero-actions">
                <a href="/rooms/new" className={buttonVariants({ size: 'lg', className: 'rounded-full' })}>
                  Start a negotiation<ArrowUpRight data-icon="inline-end" aria-hidden="true" />
                </a>
                <DemoLink size="lg" label="See a live example" />
              </div>
              ...
              <p className="landing-hero-footnote">
                The example needs no sign-up. Joining a negotiation needs no account either —
      ...
      <div className="landing-container">
        <div className="landing-questions-layout">
          <div className="landing-section-heading">
            ...
            <a className="landing-text-link" href="/demo">Or take a look around<ArrowRight className="size-4" aria-hidden="true" /></a>
          </div>
      ...
      <div className="landing-container">
        <div className="landing-footer-main">
          ...
          <nav className="landing-footer-nav" aria-label="Footer navigation">
            ...
            <a href="/demo">Explore the demo<ArrowUpRight className="size-4" aria-hidden="true" /></a>
          </nav>
        </div>
